...
train_data = object_detector.DataLoader.from_pascal_voc(
    'test_30c/train',
    'test_30c/train',
    ['beef', 'shrimp', 'spinach', 'potato', 'springonion', 'fish', 'garlic', 'pork', 'carrot', 'chilli', 'tomato', 'chicken', 'cabbage', 'egg', 'onion', 'asparagus', 'bell pepper', 'bitter gourd', 'bok choy', 'broccoli', 'cauliflower', 'corn', 'cucumber', 'ginger', 'lettuce', 'pumpkin', 'tofu', 'egg plant', 'chinese cabbage', 'okra']
)
